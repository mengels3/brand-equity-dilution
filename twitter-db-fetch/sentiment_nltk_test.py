...
def get_model_classifier(positive_cleaned_tokens_list, negative_cleaned_tokens_list):
...
def main():
	...
	classifier = get_model_classifier(positive_cleaned_tokens_list, negative_cleaned_tokens_list)
